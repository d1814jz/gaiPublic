...
namespace gai
{
    public partial class AccountingFormNew : Form
    {
        public string TableName;
        public AccountingFormNew(string TableName)
        {
            InitializeComponent();
            sqlcon.Open();
        ...
        {
            AccountingAdd objAccountingFormAdd = new AccountingAdd();
            this.Hide();
            objAccountingFormAdd.ShowDialog();
            this.Show();
            btnGridView_Click(null, null);
        }
