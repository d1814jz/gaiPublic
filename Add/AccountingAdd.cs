...
namespace gai
{
    public partial class AccountingAdd : Form
    {
        ...
        {
            string query = $"insert into Учет values ({Convert.ToInt32(textBox1.Text)},{Convert.ToInt32(textBox2.Text)},{Convert.ToInt32(textBox3.Text)},'{textBox4.Text}','{(textBox5.Text)}','{(textBox6.Text)}')\n";
        ...
        private void textBox5_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            obj.Show();
            textBox5.Text = obj.Value.ToString("yyyy-MM-dd");
        }
    }
}
