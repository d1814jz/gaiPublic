...
namespace gai
{
    public partial class DtpPeopleAdd : Form
    {
        ...
        {
            string tb4 = string.Empty;
            if (textBox4.Text == "Да")
                tb4 = "True";
            if (textBox4.Text == "Нет")
                tb4 = "false";
            string query = $"insert into Участники_ДТП values ({Convert.ToInt32(textBox1.Text)},{Convert.ToInt32(textBox2.Text)},{Convert.ToInt32(textBox3.Text)},'{tb4}')\n";
