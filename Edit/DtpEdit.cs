...
namespace gai
{
    public partial class DtpEdit : Form
    {
        ...
        private void DtpEdit_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string query = $"update ДТП set ДТП.Код_сотрудника = {Convert.ToInt32(textBox2.Text)} , ДТП.Код_улицы = {Convert.ToInt32(textBox3.Text)}, ДТП.Место = '{textBox4.Text}', ДТП.Описание = '{textBox5.Text}', ДТП.Дата = '{(textBox6.Text)}' where ДТП.Код = {code}";
