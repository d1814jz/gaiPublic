...
namespace gai
{
    public partial class HistoryEdit : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            query = $"update История set История.Код_сотрудника = {Convert.ToInt32(textBox1.Text)}, История.Код_должности = {Convert.ToInt32(textBox2.Text)}, История.Код_звания = {Convert.ToInt32(textBox3.Text)}, История.Дата = '{textBox4.Text}' where История.Код = {code}";
